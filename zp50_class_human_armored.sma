...
new const humanclass2_name[] = "Humano Armored"
new const humanclass2_info[] = "Puede llevar mucho chaleco"
new const humanclass2_shortinfo[] = "Abrigadito"
...
public plugin_precache()
{
    ...
    cvar_human_health = register_cvar("zp_human_armored_health", "0.75");
	cvar_human_armor = register_cvar("zp_human_armored_armor", "2")
    cvar_human_speed = register_cvar("zp_human_armored_speed", "0.95");
    cvar_human_gravity = register_cvar("zp_human_armored_gravity", "1.0");
	...
	g_human_armor = get_pcvar_num(cvar_human_classic_armor) * get_pcvar_float(cvar_human_armor);
