...
new const humanclass2_name[] = "Humano Raptor"
new const humanclass2_info[] = "Se mueve muy rápido"
new const humanclass2_shortinfo[] = "Rapido"
...
public plugin_precache()
{
    ...
    cvar_human_health = register_cvar("zp_human_raptor_health", "0.5");
	cvar_human_armor = register_cvar("zp_human_raptor_armor", "0.5")
    cvar_human_speed = register_cvar("zp_human_raptor_speed", "1.25");
    cvar_human_gravity = register_cvar("zp_human_raptor_gravity", "1");
