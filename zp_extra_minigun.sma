...
public plugin_init() {
	...
	clipstart = register_cvar("zp_minigun_ammo","1000")
	clipstartsuv = register_cvar("zp_minigun_survivor_ammo","0")
	m249 = 		register_cvar("zp_minigun_speed","0.7")
	DMGMG =		register_cvar("zp_minigun_damage","1")
	oneround = 	register_cvar("zp_minigun_oneround","0")
